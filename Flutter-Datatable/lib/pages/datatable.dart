  ...
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    ...
    switch (_sortColumnIndex.value) {
      case 0:
        ...
        break;
      case 1:
        _dessertsDataSource!.sort<num>((d) => d.jumlah, _sortAscending.value);
        break;
      case 2:
      ...
      body: Scrollbar(
        child: ListView(
          children: [
            PaginatedDataTable(
              header: const Text(
                  'Table Stok Barang'), // Set the header text of the data table
              ...
              columns: [
                DataColumn(
                  label: const Text('Stok Penjualan Barang'),
                ...
                DataColumn(
                  ...
                  onSort: (int columnIndex, bool ascending) =>
                      _sort<num>((d) => d.jumlah, columnIndex, ascending),
                ),
